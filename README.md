...
<h1 align="center">Gald3r for Roo Code</h1>

<p align="center">
  The <strong>Roo Code edition</strong> of Gald3r -- file-based memory, task management, and
  agent orchestration that runs <strong>inside Roo Code</strong>. Part of the Gald3r framework
...
This is the **Roo Code distribution** of Gald3r. The [`roo/`](./roo/) folder is a
complete, ready-to-deploy gald3r setup tuned for Roo Code -- drop its contents into your
...
cp -r gald3r_platform_roo/roo/. /path/to/your/project/
```

Then open the project in Roo Code and type `@g-status` to confirm gald3r loaded.

> The `roo/` payload is **additive** -- it drops in gald3r's config + `.gald3r/` state and
