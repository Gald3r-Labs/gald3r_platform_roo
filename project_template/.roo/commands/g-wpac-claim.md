...
```
@g-wpac-claim <parent_project_path>
...
> **Tip**: You only need to run one side. `@g-wpac-claim` from the child and
> `@g-wpac-adopt` from the parent both perform the same bidirectional update.
