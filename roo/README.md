...
This project runs on **[Gald3r](https://github.com/wrm3/gald3r) for Roo Code** -- file-based
...
Open this project in **Roo Code** and run **`@g-setup`** -- it initializes gald3r and fills in
